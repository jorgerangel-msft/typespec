...
namespace TypeSpec.Http
{
    ...
    public partial class File1
    {
        ...
        /// <summary> Initializes a new instance of <see cref="File1"/>. </summary>
        /// <param name="contents">
        ...
        public File1(BinaryData contents)
        {
        ...
        internal File1(File1ContentType? contentType, string filename, BinaryData contents, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// _contents_ of the file, and not necessarily the way the file itself is transmitted or serialized.
        /// </summary>
        public File1ContentType? ContentType { get; set; }
