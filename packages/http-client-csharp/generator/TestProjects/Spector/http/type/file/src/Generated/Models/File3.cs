...
namespace TypeSpec.Http
{
    ...
    public partial class File3
    {
        ...
        /// <summary> Initializes a new instance of <see cref="File3"/>. </summary>
        /// <param name="contents">
        ...
        /// </param>
        internal File3(BinaryData contents)
        {
            Contents = contents;
        }
        ...
        internal File3(DownloadFileMultipleContentTypesResponseContentType? contentType, string filename, BinaryData contents, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// _contents_ of the file, and not necessarily the way the file itself is transmitted or serialized.
        /// </summary>
        public DownloadFileMultipleContentTypesResponseContentType? ContentType { get; }
