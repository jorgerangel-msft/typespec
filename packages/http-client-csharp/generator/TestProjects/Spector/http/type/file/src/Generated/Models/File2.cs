...
namespace TypeSpec.Http
{
    ...
    public partial class File2
    {
        ...
        /// <summary> Initializes a new instance of <see cref="File2"/>. </summary>
        /// <param name="contents">
        ...
        public File2(BinaryData contents)
        {
        ...
        internal File2(FileContentType2? contentType, string filename, BinaryData contents, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// _contents_ of the file, and not necessarily the way the file itself is transmitted or serialized.
        /// </summary>
        public FileContentType2? ContentType { get; set; }
