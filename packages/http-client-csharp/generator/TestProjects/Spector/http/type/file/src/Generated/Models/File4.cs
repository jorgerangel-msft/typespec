...
namespace TypeSpec.Http
{
    ...
    public partial class File4
    {
        ...
        /// <summary> Initializes a new instance of <see cref="File4"/>. </summary>
        /// <param name="contents">
        ...
        public File4(BinaryData contents)
        {
        ...
        internal File4(string contentType, string filename, BinaryData contents, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
